...
static const char qt_meta_stringdata_VehicleACUPage[] = {
    "VehicleACUPage\0\0on_btn_prePage_pressed()\0"
    "on_btn_nextPage_pressed()\0"
    "on_btn_prePage_released()\0"
    "on_btn_nextPage_released()\0"
};

void VehicleACUPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        VehicleACUPage *_t = static_cast<VehicleACUPage *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData VehicleACUPage::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VehicleACUPage::staticMetaObject = {
    { &BasePage::staticMetaObject, qt_meta_stringdata_VehicleACUPage,
      qt_meta_data_VehicleACUPage, &staticMetaObjectExtraData }
};
